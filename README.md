...
基本上支持 Claude Code,但也可以与其他工具一起使用。请参考 [在 Claude Code 以外的工具中使用 jimu](#在-claude-code-以外的工具中使用-jimu)。
...
**注意**: 如果使用 Claude Code Plugin 安装,请在每个命令前添加 `jimu:`(例: `/jimu:kairo-requirements`)。
...
## 在 Claude Code 以外的工具中使用 jimu

通过结合使用 [rulesync](https://github.com/dyoshikawa/rulesync),也可以在 Claude Code 以外的工具中使用 jimu 命令。
